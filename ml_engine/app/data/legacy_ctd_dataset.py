"""Legacy Sprint 3 CtD prototype from the available Hetionet fragment.
...
module is preserved only as a historical graph-relation baseline. DDInter
severity in `ddinter_dataset.py` is the primary Sprint 3 task.
"""
...
OUTPUT_DIR = REPO_ROOT / "data" / "processed" / "sprint3" / "legacy_ctd"
INTERIM_DIR = REPO_ROOT / "data" / "interim" / "sprint3" / "legacy_ctd"
RANDOM_STATE = 42
TEST_SIZE = 0.2
NEGATIVE_RATIO = 2
